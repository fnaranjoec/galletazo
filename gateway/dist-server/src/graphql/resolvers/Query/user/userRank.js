...
const usersRankResolver = async (obj, args, context) => {
  // // -------------------------------- AUTENTICACION -----------------------------------
  ...
  return await Promise.all([_UserService.default.countUsers(), await _UserService.default.fetchAllUsersRank({
    args
...
var _default = usersRankResolver;
