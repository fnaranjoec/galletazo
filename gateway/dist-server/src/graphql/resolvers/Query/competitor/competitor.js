...
const competitorResolver = async (obj, args, context) => {
  ...
  return await Promise.all([_CompetitorService.default.countCompetitors(), await _CompetitorService.default.fetchAllCompetitors({
    args
...
var _default = competitorResolver;
